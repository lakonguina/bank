		...
		>
			<div class="flex items-center justify-center">
				{#if $user.status.slug == "waiting-for-validation" }
					<svg class="h-4 me-2 text-orange-500 dark:text-orange-400" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" stroke="#ffffff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
						<circle cx="12" cy="12" r="10"></circle><line x1="15" y1="9" x2="9" y2="15"></line><line x1="9" y1="9" x2="15" y2="15"></line>
					</svg>
					Votre compte est en cours de validation.
				{:else}
					<svg class="h-4 me-2 text-green-500 dark:text-green-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
